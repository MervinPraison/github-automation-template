...
const COPILOT_TRIGGER_LOGINS = new Set(config.triggerLogins || ['github-actions[bot]']);
const CLAUDE_TRIGGER_LOGINS = new Set(config.triggerLogins || ['github-actions[bot]']);
